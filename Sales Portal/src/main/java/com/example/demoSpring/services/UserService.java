...
// dupa user ID check changeAddress and get UserAddress
    ...
    private Company getUserAddress(User u){
        Company address = u.getAddress();
        if(address == null){
            address = new Company();
            address.setUser(u);
        }
